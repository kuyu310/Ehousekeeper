...
//        
//        self.menu.size = CGSize(width: self.width / 5, height: self.height)
//        
//         var btnIdex = 0 ;
//        for  btn in self.subviews {      //遍历tabbar的子控件
//            if btn.isKind(of: cls) {
//                
//                btn.width = self.width/5
//                btn.x = btn.width * btnIdex
//                btnIndex += btnIdex
//                
//            }
//            if (btnIndex == 2) {
