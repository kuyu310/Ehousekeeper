...
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
    ...
    WMVideoMessage *message = (WMVideoMessage *)model.content;
    CGSize size = [WMVideoMessageCell getBubbleBackgroundViewSize:message];
    
//    CGFloat __messagecontentview_height = size.height;
        CGFloat __messagecontentview_height = 150.0f;
...
+ (CGSize)getBubbleBackgroundViewSize:(WMVideoMessage *)message {
    CGSize textLabelSize = [[self class] getTextLabelSize:message];
    return [[self class] getBubbleSize:textLabelSize];
}
+ (CGSize)getTextLabelSize:(WMVideoMessage *)message {
...
- (void)initialize {
    ...
    [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longPressed1:)];
