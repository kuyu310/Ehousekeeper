...
- (void)tapTextMessage:(UIGestureRecognizer *)gestureRecognizer{
    ...
    [self.CustomeDalegate didTapMessageCell_Custom:self.model];
    
    
//    if ([self.CustomeDalegate respondsToSelector:@selector(didTapMessageCell_Custom:)]) {
//        
//        [self.CustomeDalegate didTapMessageCell_Custom:self.model];
//        
//    }
...
//- (void)tapTextMessage11:(UIGestureRecognizer *)gestureRecognizer {
//    
//    
//  if ([self.CustomeDalegate respondsToSelector:@selector(didTapMessageCell_Custom:)]) {
//      
