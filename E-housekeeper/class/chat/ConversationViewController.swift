...
class ConversationViewController: RCConversationViewController,RCMessageCellCustomDelegate {
...
//
    ...
    override func pluginBoardView(_ pluginBoardView: RCPluginBoardView!, clickedItemWithTag tag: Int) {
        ...
        case 201:
            ...
            let videoMessage = WMVideoMessage(content: "http://admin.weixin.ihk.cn/ihkwx_upload/test.mp4")
        ...
        case 202:
            ...
            let TestMsg = RCDTestMessage(content: "你发布了一个任务")
            ...
            self.sendMessage(TestMsg!, pushContent: nil)
...
//委托
 ...
 func didTapMessageCell_Custom( _ model: RCMessageModel!) {
    
        if model.content.isKind(of: RCDTestMessage.self){
